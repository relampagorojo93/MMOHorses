...
public class ListAllSubCommand extends SubCommand {
	public ListAllSubCommand(Command command) {
		super(command, "listall", SettingString.HORSE_LISTALL_NAME.toString(), SettingString.HORSE_LISTALL_PERMISSION.toString(),
				SettingString.HORSE_LISTALL_DESCRIPTION.toString(), "",
				SettingList.HORSE_LISTALL_ALIASES.toList());
	}
