...
public class BuySubCommand extends SubCommand {
	public BuySubCommand(Command command) {
		super(command, "buy", SettingString.HORSE_BUY_NAME.toString(), SettingString.HORSE_BUY_PERMISSION.toString(),
				SettingString.HORSE_BUY_DESCRIPTION.toString(), "",
				SettingList.HORSE_BUY_ALIASES.toList());
	}
	...
	public boolean execute(Command cmd, CommandSender sender, String[] args, boolean useids) {
		...
		if (p != null)
			new BuyInventory(p).openInventory(MMOHorsesAPI.getPlugin());
		else
