...
public class ZombieHorseCustom extends EntityHorseZombie implements NMSMMOHorse {
	...
	public ZombieHorseCustom(EntityTypes<? extends EntityHorseZombie> entitytypes, World w) { // Required
		super(entitytypes, w);
		data.initialize();
	}

	public ZombieHorseCustom(EntityTypes<? extends EntityHorseZombie> entitytypes, Location l) { // Required
	...
	public ZombieHorseCustom(Location l) {
		this(EntityTypes.ZOMBIE_HORSE, l);
	}
	...
	public ZombieHorseCustom createEntity(World world) {
		return new ZombieHorseCustom(EntityTypes.ZOMBIE_HORSE, world);
	}
