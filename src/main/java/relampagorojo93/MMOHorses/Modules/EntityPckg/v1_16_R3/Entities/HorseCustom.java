...
public class HorseCustom extends EntityHorse implements NMSMMOHorse {
	...
	public HorseCustom(Location l) {
		this(EntityTypes.HORSE, ((CraftWorld) l.getWorld()).getHandle());
	...
	public HorseCustom createEntity(World world) {
		return new HorseCustom(EntityTypes.HORSE, world);
	}
	...
	@Override
	public boolean l(net.minecraft.server.v1_16_R3.ItemStack var0) {
