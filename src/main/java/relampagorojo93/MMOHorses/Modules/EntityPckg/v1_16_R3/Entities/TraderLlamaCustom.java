...
public class TraderLlamaCustom extends EntityLlamaTrader implements NMSMMOHorse {
	...
	public TraderLlamaCustom(EntityTypes<? extends EntityLlamaTrader> entitytypes, World w) { // Required
		super(entitytypes, w);
		data.initialize();
	}

	public TraderLlamaCustom(EntityTypes<? extends EntityLlamaTrader> entitytypes, Location l) { // Required
	...
	public TraderLlamaCustom(Location l) {
		this(EntityTypes.TRADER_LLAMA, l);
	}
	...
	public Type getType() {
		return Type.TRADERLLAMA;
	}

	@Override
	public TraderLlamaCustom createEntity(org.bukkit.World world) {
		return createEntity(((CraftWorld) world).getHandle());
	}

	public TraderLlamaCustom createEntity(World world) {
		return new TraderLlamaCustom(EntityTypes.TRADER_LLAMA, world);
	}
