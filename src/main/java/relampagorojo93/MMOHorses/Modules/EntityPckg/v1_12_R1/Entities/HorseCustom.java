...
public class HorseCustom extends EntityHorse implements NMSMMOHorse {
	...
	@Override
	public void g(net.minecraft.server.v1_12_R1.ItemStack var0) {
		super.g(var0);
		if (!SettingBoolean.MAKECOSMETICSFUNCTIONAL.toBoolean()
				|| (getMMOHorseData() != null && getMMOHorseData().isClaimed()
						&& getMMOHorseData().getClaimedData().getCosmetics().getBody() == null))
			getAttributeInstance(GenericAttributes.h).b(UUID.fromString("556E1665-8B10-40C8-8F9D-CF9B1667F295"));
	}
	...
	public void updateVariant() {
		...
		if (colour == null || colour == Colour.NULL)
			colour = Colour.values()[0];
		if (marking == null || marking == Marking.NULL)
			marking = Marking.NONE;
		this.setVariant(colour.toBukkitHorse().ordinal() & 0xFF | marking.toBukkit().ordinal() << 8);
	}
