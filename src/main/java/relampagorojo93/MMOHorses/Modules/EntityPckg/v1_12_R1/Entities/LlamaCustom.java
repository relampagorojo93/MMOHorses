...
public class LlamaCustom extends EntityLlama implements NMSMMOHorse {
	...
	public int getVariant() {
		...
		return colour != null && colour.toBukkitLlama() != null ? colour.toBukkitLlama().ordinal()
				: Colour.values()[0].toBukkitLlama().ordinal();
	}
